...
<%
	ArrayList<Member> reportmemberList = (ArrayList<Member>)request.getAttribute("reportmemberList");
%>
...
<h2 id="actH2" align="center">회원 정보 조회 - 누적신고수 순</h2>
    ...
    <table id="memberlist" align="center">
        ...
        <tr>
            ...
            <% if(reportmemberList.isEmpty()){ %>
				<tr><td colspan="3">신고 된 회원이 없습니다.</td></tr>
				<% } else { %>
