package com.kh.board.handOver.model.vo;
...
public class HandOver {
	...
	public HandOver(int boardNo, int memberNo, String boardType, String category, String boardTitle,
	...
	public String toString() {
		return "HandOver [boardNo=" + boardNo + ", memberNo=" + memberNo + ", boardType=" + boardType + ", category="
