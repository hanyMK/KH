 ...
 */
@WebServlet("/acceptReport.bo")
public class AjaxBoardAcceptReportController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxBoardAcceptReportController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//신고처리 완료 => boardStatus => Y /memberNo를 이용해서 사용자 신고수 없데이트?
		int boardNo = Integer.parseInt(request.getParameter("bno"));
		int memberNo =  Integer.parseInt(request.getParameter("mno"));
		
		int result = new ReportManagerService().updateBoardReport(boardNo, memberNo);
