...
public class ChallengeAttachment {
	...
	public ChallengeAttachment(int fileNo, int boardNo, int fileLevel, String originName, String changeName,
	...
	public String toString() {
		return "ChallengeAttachment [fileNo=" + fileNo + ", boardNo=" + boardNo + ", fileLevel=" + fileLevel
