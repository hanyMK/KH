package com.kh.board.offer.model.vo;
...
public class OfferBoard {
	...
	public OfferBoard(int boardNo, int memberNo, String boardType, String category, String boardTitle,
			String boardContent, String createDate, String updateDate, int boardCount, String voteYN, String hashtagYN,
			String boardStatus, int boardReportNo, String alertStatus, String closingDate, String email,
			String nickName) {
		super();
	...
	public String toString() {
		return "OfferBoard [boardNo=" + boardNo + ", memberNo=" + memberNo + ", boardType=" + boardType + ", category="
