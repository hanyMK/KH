      ...
      $.ajax({
            ...
            success : function(list){
              ...
              if(list.length == 0 ){
                ...
                '<div class="box">'
                  +'<tr>'
                  + '<td id="textMsg" colspan="6">조회된 게시글이 없습니다</td>' 
                  +'</tr>'
                  +'</div>';
                      ...
                      '<div class="box">'
                          +'<table class="an_3" cellspacing="1">'                       
                            ...
                            +'<tr>'
                               ...
                               +' <td class="reply_3"><img class="replyImg" src="resources/thumbnail_upFiles/NoSweat_20230503104404_24177.png">' +  list[i].replyCount   +'</td> '   
                            +'</tr>'
                            ...
                            +' <tr>'
                                +' <td colspan="2">	</td>'
                                +'<td colspan="2"><img>'
                                +' <span class="heart-shape">♥</span>'+ list[i].postLike
                                +'</td>'
