...
<%
	ArrayList<Member> idmemberList = (ArrayList<Member>)request.getAttribute("idmemberList");
	ArrayList<Member> nickmemberList = (ArrayList<Member>)request.getAttribute("nickmemberList");
...
<div id="wrap_12">
    ...
    <form action="">
        <table id="memberlist" align="center">
            <tr>
                <td colspan="7">
                    <select id="search" name="search">
                        ...
                        <option name="search" value="report">누적신고수 Rank</option>
            ...
            <% if(idmemberList.isEmpty() && nickmemberList.isEmpty()){ %>
				<tr><td colspan="3">검색 결과 회원이 없습니다.</td></tr>
				<% } else if(idmemberList.isEmpty()){  %>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="memType" id="memberType">
                                    <% if(m.getMemberType().equals("일반 회원")) { %>
